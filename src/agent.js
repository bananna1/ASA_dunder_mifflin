...
import {client, BeliefCose} from "./beliefcose.js"
import fs from 'fs';
...
class PlanMove extends Plan {
    ...
    async execute ( go_to, x, y ) {    
        ...
        var array_directions = await belief.generate_plan(x_from, y_from, x, y);
        console.log("arary directions:",array_directions)
        for (var dir of array_directions) {
            if (this.stopped) throw ['stopped'];
            console.log("iiiiiiiiiiiiiiiii")
            console.log(await client.move(dir));
        }
        // belief.generate_plan(x_from, y_from, x, y)
        // .then(array_directions=>{
        //     console.log("array directions:",array_directions)
